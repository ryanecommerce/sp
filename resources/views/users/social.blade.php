            ...
            <form action="{{ route('social.update')  }}" method="POST" class="form__auth">
                ...
                <div class="form-group {{ $errors->has('agree_term','agree_privacy')  ? 'has-error' : '' }}{{ $errors->has('agree_privacy') ? 'has-error' : '' }}">
                    ...
                    <div class="terms_box">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="agree_terms" value="1" class="form-control form-check-input"  {{ (! empty(old('agree_terms')) ? 'checked' : '') }}>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="terms_box down_box">
                        ...
                        <div class="form-check">
                            <label class="form-check-label">
                                <input type="checkbox" name="agree_privacy" value="1" class="form-control form-check-input">
                            </label>
                        </div>
                    </div>
